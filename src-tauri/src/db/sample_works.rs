use super::seed::{SampleChapter, SampleKnowledge, SampleScene, SampleWork};

pub const GINGA_TETSUDO_NO_YORU: SampleWork = SampleWork {
    name: "銀河鉄道の夜",
    outline: &[
        SampleChapter {
            title: "本編",
            scenes: &[
                SampleScene {
                    title: "一、午后の授業",
                    synopsis: "先生が銀河の正体を問う。ジョバンニは答えを知っているのに立ち上がれない。カムパネルラもわざと黙る。かつて二人で星の写真を見たことがあるのに。",
                    body: "「ではみなさんは、そういうふうに川だと云われたり、乳の流れたあとだと云われたりしていたこのぼんやりと白いものがほんとうは何かご承知ですか。」先生は、黒板に吊した大きな黒い星座の図の、上から下へ白くけぶった銀河帯のようなところを指しながら、みんなに問をかけました。
...
　そして教室中はしばらく机の蓋をあけたりしめたり本を重ねたりする音がいっぱいでしたがまもなくみんなはきちんと立って礼をすると教室を出ました。",
                ...
                SampleScene {
                    title: "二、活版所",
                    synopsis: "放課後、活版所で活字を拾う。日当は銀貨一枚。パンと角砂糖を買って帰路へ。角砂糖は病気の母の牛乳に入れるため。",
                    body: "　ジョバンニが学校の門を出るとき、同じ組の七八人は家へ帰らずカムパネルラをまん中にして校庭の隅の桜の木のところに集まっていました。それはこんやの星祭に青いあかりをこしらえて川へ流す烏瓜を取りに行く相談らしかったのです。
...
　ジョバンニはおじぎをすると扉をあけてさっきの計算台のところに来ました。するとさっきの白服を着た人がやっぱりだまって小さな銀貨を一つジョバンニに渡しました。ジョバンニは俄かに顔いろがよくなって威勢よくおじぎをすると台の下に置いた鞄をもっておもてへ飛びだしました。それから元気よく口笛を吹きながらパン屋へ寄ってパンの塊を一つと角砂糖を一袋買いますと一目散に走りだしました。",
                ...
                SampleScene {
                    title: "三、家",
                    synopsis: "母との会話。父の不在への不安、「らっこの上着」の件。カムパネルラの家で汽車の模型で遊んだ頃の回想。母に送り出され、牛乳を取りに町へ出る。",
                    body: "　ジョバンニが勢よく帰って来たのは、ある裏町の小さな家でした。その三つならんだ入口の一番左側には空箱に紫いろのケールやアスパラガスが植えてあって小さな二つの窓には日覆いが下りたままになっていました。
...
「では一時間半で帰ってくるよ。」と云いながら暗い戸口を出ました。",
                ...
                SampleScene {
                    title: "四、ケンタウル祭の夜",
                    synopsis: "ケンタウル祭の町を歩く。時計屋の星座早見盤に見入る。牛乳屋で門前払い。ザネリたちに「らっこの上着」と囃し立てられ、カムパネルラはただ黙っている。丘へ走り出す。",
                    body: "　ジョバンニは、口笛を吹いているようなさびしい口付きで、檜のまっ黒にならんだ町の坂を下りて来たのでした。
...
　ジョバンニは、遁げるようにその眼を避け、そしてカムパネルラのせいの高いかたちが過ぎて行って間もなく、みんなはてんでに口笛を吹きました。町かどを曲るとき、ふりかえって見ましたら、ザネリがやはりふりかえって見ていました。そしてカムパネルラもまた、高く口笛を吹いて向うにぼんやり見える橋の方へ歩いて行ってしまったのでした。ジョバンニは、なんとも云えずさびしくなって、いきなり走り出しました。すると耳に手をあてて、わああと云いながら片足でぴょんぴょん跳んでいた小さな子供らは、ジョバンニが面白くてかけるのだと思ってわあいと叫びました。まもなくジョバンニは黒い丘の方へ急ぎました。",
                ...
                SampleScene {
                    title: "五、天気輪の柱",
                    synopsis: "天気輪の柱のそば、つめたい草に身を投げ出す。遠い汽車の窓明かりを見て、何とも云えず悲しくなる。ここから銀河鉄道の旅へ転換。",
                    body: "　牧場のうしろはゆるい丘になって、その黒い平らな頂上は、北の大熊星の下に、ぼんやりふだんよりも低く連って見えました。
...
　ところがいくら見ていても、そのそらはひる先生の云ったような、がらんとした冷いとこだとは思われませんでした。それどころでなく、見れば見るほど、そこは小さな林や牧場やらある野原のように考えられて仕方なかったのです。そしてジョバンニは青い琴の星が、三つにも四つにもなって、ちらちら瞬き、脚が何べんも出たり引っ込んだりして、とうとう蕈のように長く延びるのを見ました。またすぐ眼の下のまちまでがやっぱりぼんやりしたたくさんの星の集りか一つの大きなけむりかのように見えるように思いました。",
                ...
                SampleScene {
                    title: "六、銀河ステーション",
                    synopsis: "「銀河ステーション」の声。目の前が一斉に明るくなる。列車の中、向かいにカムパネルラ。黒曜石の星図、銀いろのすすき、りんどうの花。銀河の風景を畳みかけて旅の始まりを描く。",
                    body: "　そしてジョバンニはすぐうしろの天気輪の柱がいつかぼんやりした三角標の形になって、しばらく蛍のように、ぺかぺか消えたりともったりしているのを見ました。それはだんだんはっきりして、とうとうりんとうごかないようになり、濃い鋼青のそらの野原にたちました。いま新らしく灼いたばかりの青い鋼の板のような、そらの野原に、まっすぐにすきっと立ったのです。
...
　と思ったら、もう次から次から、たくさんのきいろな底をもったりんどうの花のコップが、湧くように、雨のように、眼の前を通り、三角標の列は、けむるように燃えるように、いよいよ光って立ったのです。",
                ...
                SampleScene {
                    title: "七、北十字とプリオシン海岸",
                    synopsis: "北十字の白い十字架と旅人たちの祈り。白鳥停車場で下車、水晶の砂の河原を歩いてプリオシン海岸へ。大学士が百二十万年前の獣の骨を発掘中。",
                    body: "「おっかさんは、ぼくをゆるして下さるだろうか。」
...
　そして二人は、前のあの河原を通り、改札口の電燈がだんだん大きくなって、間もなく二人は、もとの車室の席に座って、いま行って来た方を、窓から見ていました。",
                ...
                SampleScene {
                    title: "八、鳥を捕る人",
                    synopsis: "赤髯の鳥捕りが乗ってくる。鷺を押し葉にして売る商売。雁を勧められ食べるとお菓子の味。男はふいに消え、河原で鷺を捕まえてまた戻ってくる。",
                    body: "「ここへかけてもようございますか。」
...
「ああ、遠くからですね。」鳥捕りは、わかったというように雑作なくうなずきました。",
                ...
                SampleScene {
                    title: "九、ジョバンニの切符",
                    synopsis: "車掌の検札。ポケットから見覚えのない緑の紙。鳥捕りが驚く——「ほんとうの天上へさえ行ける切符だ」。ジョバンニの旅が他の乗客とは根本的にちがうことがわかる。",
                    body: "「もうここらは白鳥区のおしまいです。ごらんなさい。あれが名高いアルビレオの観測所です。」
...
　ジョバンニはもういろいろなことで胸がいっぱいでなんにも云えずに博士の前をはなれて早くお母さんに牛乳を持って行ってお父さんの帰ることを知らせようと思うともう一目散に河原を街の方へ走りました。",
    ...
    knowledge: &[
        SampleKnowledge {
            title: "ジョバンニ",
            body: r#"<p>主人公。貧しい家庭の少年。</p><h2>境遇</h2><ul><li>父は漁に出たきり帰らない</li><li>母は病気で寝ている</li><li>活版所でアルバイトをしている</li></ul><h2>性格</h2><ul><li>内気で孤独</li><li>学校ではいじめられている</li><li>カムパネルラとは幼馴染</li></ul>"#,
            type_index: 0,
        },
        SampleKnowledge {
            title: "カムパネルラ",
            body: r#"<p>ジョバンニの幼馴染で親友。</p><h2>境遇</h2><ul><li>裕福な家庭の子</li><li>父は博士</li></ul><h2>性格</h2><ul><li>優しく思いやりがある</li><li>ジョバンニを気遣っている</li></ul><h2>結末</h2><p>川で溺れたザネリを助けようとして命を落とす。銀河鉄道の旅はカムパネルラの死後の旅でもあった。</p>"#,
            type_index: 0,
        },
        SampleKnowledge {
            title: "ザネリ",
            body: r#"<p>ジョバンニのクラスメイト。</p><h2>性格</h2><ul><li>いじわるでジョバンニをからかう</li><li>「らっこの上着」とはやし立てる</li></ul><h2>結末</h2><p>ケンタウル祭の夜、川で溺れかけたところをカムパネルラに助けられる。カムパネルラはザネリを救うために命を落とした。</p>"#,
            type_index: 0,
        },
        SampleKnowledge {
            title: "鳥捕り",
            body: r#"<p>銀河鉄道の車内で出会う不思議な男。</p><h2>特徴</h2><ul><li>鷺やかわせみを捕まえて押し葉にする</li><li>捕った鳥はお菓子のように食べられる</li><li>突然消えたり現れたりする</li></ul><h2>象徴</h2><p>労働者階級、あるいは死者の魂を導く存在とも解釈される。</p>"#,
            type_index: 0,
        },
        SampleKnowledge {
            title: "青年と姉弟",
            body: r#"<p>サウザンクロス手前で乗車してくる三人組。</p><h2>背景</h2><ul><li>船が氷山にぶつかって沈没した</li><li>タイタニック号を暗示している</li></ul><h2>人物</h2><ul><li>青年：家庭教師。子どもたちを守ろうとした</li><li>かおる：少女。弟思いの優しい姉</li><li>タダシ：少年。姉と一緒にいる</li></ul>"#,
            type_index: 0,
        },
        SampleKnowledge {
            title: "作品情報",
            body: r#"<h2>銀河鉄道の夜</h2><p>宮沢賢治の代表作。未定稿のまま遺され、死後に発見された童話。</p><h2>執筆時期</h2><p>1924年頃から1931年頃まで、何度も改稿が重ねられた。</p><h2>テーマ</h2><ul><li>友情と別れ</li><li>生と死</li><li>自己犠牲</li><li>本当の幸せとは何か</li></ul><h2>著作権</h2><p>宮沢賢治（1896-1933）の死後70年以上経過し、パブリックドメイン。</p><p>出典: 青空文庫</p>"#,
            type_index: 1,
        },
        SampleKnowledge {
            title: "銀河鉄道の世界",
            body: r#"<h2>概要</h2><p>天の川を走る幻想的な鉄道。現実と夢、生と死の境界を越えて走る。</p><h2>特徴</h2><ul><li>車窓からは銀河の星々が見える</li><li>乗客は様々な事情を持つ人々（多くは死者）</li><li>終点はそれぞれの「ほんとうの幸い」</li></ul>"#,
            type_index: 1,
        },
        SampleKnowledge {
            title: "銀河ステーション",
            body: r#"<p>銀河鉄道の出発駅。</p><h2>特徴</h2><ul><li>天の川の中に浮かぶ駅</li><li>ジョバンニとカムパネルラが旅を始める場所</li><li>「銀河ステーション、銀河ステーション」というアナウンスが響く</li></ul>"#,
            type_index: 2,
        },
        SampleKnowledge {
            title: "白鳥の停車場",
            body: r#"<p>北十字（ノーザンクロス）付近の停車場。</p><h2>風景</h2><ul><li>すすきの穂が一面に広がる</li><li>天の川の水が銀色に輝く</li><li>プリオシン海岸が近くにある</li></ul>"#,
            type_index: 2,
        },
        SampleKnowledge {
            title: "プリオシン海岸",
            body: r#"<p>白鳥の停車場近くの海岸。</p><h2>特徴</h2><ul><li>化石発掘が行われている</li><li>くるみの化石がある</li><li>百二十万年前の地層</li></ul><h2>象徴</h2><p>過去と現在、時間の流れを象徴する場所。</p>"#,
            type_index: 2,
        },
        SampleKnowledge {
            title: "サウザンクロス（南十字）",
            body: r#"<p>銀河鉄道の重要な停車駅。</p><h2>特徴</h2><ul><li>多くの乗客がここで降りる</li><li>十字架が輝く神聖な場所</li><li>青年と姉弟もここで降車</li></ul><h2>象徴</h2><p>キリスト教的な救済、天国の入り口を暗示。</p>"#,
            type_index: 2,
        },
        SampleKnowledge {
            title: "石炭袋",
            body: r#"<p>南十字の先にある暗黒星雲。</p><h2>特徴</h2><ul><li>真っ暗な穴のように見える</li><li>カムパネルラが消えた場所</li><li>ジョバンニが一人取り残される</li></ul><h2>象徴</h2><p>死、別れ、あるいは再生への入り口。</p>"#,
            type_index: 2,
        },
    ],
};
